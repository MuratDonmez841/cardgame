...
public class kolay_Database extends SQLiteOpenHelper {

    private static final int DATABASE_VERSION = 1;
    private static final String DATABASE_NAME = "kolay_database";
    private static final String TABLE_NAME = "Skorlar_kolay";
    ...
    public kolay_Database(Context context) {
    ...
    public void kolay_skorEkle(String kullanici_adi,String puan,String dbsure) {
        SQLiteDatabase db = this.getWritableDatabase();
    ...
    public ArrayList<HashMap<String, String>> kolay_skorlar(){
        SQLiteDatabase db = this.getReadableDatabase();
        String selectQuery = "SELECT * FROM " + TABLE_NAME;
        Cursor cursor = db.rawQuery(selectQuery, null);
        ArrayList<HashMap<String, String>> kolay_skor = new ArrayList<HashMap<String, String>>();
    ...
    public void kolay_tabloTemizle(){
        SQLiteDatabase db = this.getWritableDatabase();
